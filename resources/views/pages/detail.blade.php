    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card card-details card-right">
                    <h2>Fasilitas yang tidak didapat</h2>
                    <div class="members my-2">
                        <img src="frontend/images/members.png" alt="" class="w-75" />
                    </div>
                    <hr />
                    ...
                    <div class="gallery">
                        <div class="xzoom-container">
                            <table class="table table-striped text-center">
                                <thead>
                                    <tr>
                                        <th scope="col" class="bg-warning">Bolo 1</th>
                                        <th scope="col" class="bg-success">Bolo 2</th>
                                        <th scope="col" class="bg-primary">Bolo 3</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
